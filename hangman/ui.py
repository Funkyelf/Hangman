...
from constants import (Colors, DIFFICULTIES, HANGMAN)
...
class TerminalUI:
    ...
    def banner():
        ...
        print(Colors.CYAN+Colors.BOLD+"="*35)
    ...
    def display(game):
        ...
        print(Colors.BOLD+game.display_word+Colors.RESET)

        print()

        if game.wrong_letters:

            print("Wrong letters:", ", ".join(sorted(game.wrong_letters)))
    ...
    def show_hint(hint):
        ...
        print(Colors.YELLOW+"Hint: "+hint+Colors.RESET)
    ...
    def game_over(game):
        ...
        if game.won:
            ...
            print(Colors.GREEN+"YOU WON!"+Colors.RESET)

        else:

            print(Colors.RED+"YOU LOST!"+Colors.RESET)

            print(f"The word was: {game.word.value}")
